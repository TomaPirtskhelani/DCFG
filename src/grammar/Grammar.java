...
public class Grammar {
    ...
    private void readTerminals(Scanner in) {
        while (in.hasNext()) {
            ...
            terminals.add(new Symbol(terminal, Type.Terminal));
        }
        terminals.add(new Symbol("|", Type.Terminal));
    }
    ...
    private void readNonterminals(Scanner in) {
        while(in.hasNext()){
            ...
            nonterminals.add(new Symbol(parts[0], Type.Nonterminal));
        }
    }
    ...
    private void readProductions(Scanner in){
        while(in.hasNext()){
            ...
            for (Symbol symbol : production.getRight()) {
                if(symbol.equals(new Symbol("|", Type.Terminal))) {
